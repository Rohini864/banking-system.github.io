	...
	?>
	 ...
	 <tr>
            <td data-th="id"><?php echo $res['id']; ?></td>
                ...
                <td data-th="Balance"><a href="select_trans.php?id=<?php echo $res['id']; ?>"> <button type="button" class="btn" style="background-color : rgb(154, 239, 241);;">Transfer</button></a></td>
            </tr>
